...
# Ajout des contextes sur Django + modèles + ORM
# Ajout un long running task => cache/celery/async
# Améliorer la DB schema
# Repetitive code
...
class Video(models.Model):
    ...
    alertlabel = models.ForeignKey(Alert_Label, on_delete=models.SET_NULL, null=True)
    ...
    if request.method == "PATCH":
        ...
        # We can remove else here
            ...
            try:
                ...
                video.alertlabel = label[0]  # label is a tuple => inconsistent use of get_or_create
